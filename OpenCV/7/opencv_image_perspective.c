...
Point2f Source[] = {Point2f(0,0), Point2f(-270,340), Point2f(640,0), Point2f(640+300,340)};
...
int main(void)
{
    ...
    { 
      ...
      vector<Vec4i> linesP;
      //HoughLinesP(mat_image_canny_edge, linesP, 1, CV_PI/200,35,40,25);
      HoughLinesP(image, linesP, 1, CV_PI/200,35,40,25);
